...
// Source: gilanggsb/simplebank/db/sqlc (interfaces: Store)
//
...
import (
	context "context"
	sqlc "gilanggsb/simplebank/db/sqlc"
	reflect "reflect"
...
func (m *MockStore) ListTransfer(ctx context.Context, arg sqlc.ListTransferParams) ([]sqlc.Transfers, error) {
	m.ctrl.T.Helper()
